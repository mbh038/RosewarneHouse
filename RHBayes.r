...
ymax=max(u4p$T2,na.rm=TRUE)
ymin=min(u4p$T1,na.rm=TRUE)
...
lines(u4p$id[index],u4p$hp2[index],col="blue",type="l")

plot(u4p$id[index],u4p$hp1flux1[index],type="l")
lines(u4p$id[index],u4p$hp2flux2[index],col="blue",type="l")
